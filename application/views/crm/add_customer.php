...
<div class="form-element-area" style="margin-top: 25px;">
        <div class="container">
            <form action="" id="add_customer" method="post" enctype="multipart/form-data">
            <div class="row">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_birth" id="customer_birth" class="form-control">
                                </div>
                            </div>
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="customer_email" id="customer_email" class="form-control" placeholder="">
                                </div>
                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="interests" id="interests" class="form-control" placeholder="">
                                </div>
                            </div>
   ...
   <!--  <script src="<?=base_url()?>crm_manucare/js/tawk-chat.js"></script> -->
    ...
    $('#add_customer').submit(function (event) {
        ...
        $.ajax({
        type: "POST",
        url: "<?=base_url()?>crm/customer/addCustomerAjax",
