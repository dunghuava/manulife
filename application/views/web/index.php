...
<?php 
    ...
    $dichvu = $this->Web_M->q("select a.post_id,a.post_title,b.cate_title,a.post_img,a.post_alias from db_post a inner join db_category b on a.post_category_id=b.cate_id order by rand() limit 6");
?>
<section class="sec-product">
    <div class="container full-w"><br>
        <div class="row">
